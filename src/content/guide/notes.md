...
Notes are for anything you want to write down and keep: a thought, a meeting summary, a draft, a list. They're written in **markdown**, so light formatting works as you type.
...
To edit a note already on the canvas, click it on desktop, or long-press it on mobile to open the editor as a floating drawer. Editing an existing note doesn't let you move it to a different folder, so pick the folder when you create it.
...
A note folder can be shared as a public link. See **Public links**.
