    ...
    <div className="public-page min-h-screen flex flex-col bg-app-surface text-app-ink">
      ...
      <main className="flex-1">
        <div className="max-w-[720px] mx-auto px-4 sm:px-6 py-14 sm:py-20">
          ...
          <div className="mt-14 pt-8 border-t border-app-line flex gap-6 text-sm text-app-ink-faint">
            <Link to="/privacy" className="underline underline-offset-2 hover:text-app-ink-muted transition-colors">
              Privacy Policy
            </Link>
            <Link to="/" className="hover:text-app-ink-muted transition-colors">
              ← Back to home
            </Link>
          </div>
        </div>
